...
print(f"Alínea a): {z.list_associations()}")
print(f"Alínea b): {z.list_objects()}")
print(f"Alínea c): {z.list_users()}")
print(f"Alínea d): {z.list_types()}")
print(f"Alínea e): {z.list_local_associations('socrates')}")
print(f"Alínea f): {z.list_relations_by_user('descartes')}")
print(f"Alínea g): {z.associations_by_user('descartes')}")
print(f"Alínea h): {z.list_local_associations_and_user('socrates')}")
print(f"Alínea i): {z.predecessor('vertebrado', 'socrates')}")
print(f"Alínea i): {z.predecessor('vertebrado', 'filosofo')}")
print(f"Alínea h): {z.predecessor_path('vertebrado', 'socrates')}")
print(f"Alínea : {z.query_local_assoc('socrates', 'pai')}")