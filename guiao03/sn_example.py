...
print(f"Alínea 3. c): {z.list_users()}")
print(f"Alínea 3. d): {z.list_types()}")
print(f"Alínea 3. e): {z.list_local_associations('socrates')}")
print(f"Alínea 3. f): {z.list_relations_by_user('descartes')}")
print(f"Alínea 3. g): {z.associations_by_user('descartes')}")
print(f"Alínea 3. h): {z.list_local_associations_and_user('socrates')}")
print(f"Alínea 3. i): {z.predecessor('vertebrado', 'socrates')}")
print(f"Alínea 3. i): {z.predecessor('vertebrado', 'filosofo')}")